"""V0.8e zero-cost complete video assembly (isolated, no API calls).
...
but with output/v08d_avatar_cover.mp4 (native HeyGen Avatar IV fit=cover)
as the ONLY avatar source.

ONLY VARIABLE VS V0.8c: avatar source swapped from
output/v08b_avatar_crop.mp4 to output/v08d_avatar_cover.mp4.
Everything else (windows, B-roll timing, transitions, audio handling)
is unchanged from the proven V0.8c/V0.7 implementation.
...
Usage:
    PYTHONPATH=. uv run python scripts/v08e_native_avatar_broll_assembly.py
"""
...
AVATAR = "output/v08d_avatar_cover.mp4"
OUTPUT = "output/v08e_native_avatar_broll_assembly.mp4"
